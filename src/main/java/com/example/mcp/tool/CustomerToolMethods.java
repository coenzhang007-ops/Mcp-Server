...
public class CustomerToolMethods {
    ...
    @McpToolDef(
            ...
            description = "Query CRM customer information by company name or partial keyword. Use this when the user asks to search CRM customers, company profiles, or customer info such as 查询包含vadas的客户信息."
    )
    public Map<String, Object> queryCustomerInfo(CustomerInfoRequest request) {
        return customerMcpService.queryCustomerInfo(request.company());
    }
